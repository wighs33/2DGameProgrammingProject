...
def draw():
    ...
    draw_progress(center_x, 300, 1080, progress)
...
IMAGE_FILES = [
    ...
    "res/unitfiles/Ace/Attack (1).png",
    "res/unitfiles/Ace/Attack (2).png",
    "res/unitfiles/Ace/Attack (3).png",
    "res/unitfiles/Ace/Attack (4).png",
    "res/unitfiles/Ace/Attack (5).png",
    "res/unitfiles/Ace/Attack (6).png",
    "res/unitfiles/Ace/Attack (7).png",
    "res/unitfiles/Ace/Attack (8).png",
    "res/unitfiles/Ace/Attack (9).png",
    "res/unitfiles/Ace/Attack (10).png",
    "res/unitfiles/Ace/Attack (11).png",
    "res/unitfiles/Ace/Attack (12).png",
    "res/unitfiles/Ace/Attack (13).png",
    "res/unitfiles/Ace/Attack (14).png",
    "res/unitfiles/Ace/Attack (15).png",
    "res/unitfiles/Ace/Attack (16).png",
    "res/unitfiles/Ace/Attack (17).png",
    "res/unitfiles/Ace/Attack (18).png",
    "res/unitfiles/Ace/Attack (19).png",
    "res/unitfiles/Ace/Attack (20).png",
    "res/unitfiles/Ace/Idle (1).png",
    "res/unitfiles/Ace/Idle (2).png",
    "res/unitfiles/Ace/Idle (3).png",
    "res/unitfiles/Ace/Idle (4).png",
    "res/unitfiles/Ace/Walk (1).png",
    "res/unitfiles/Ace/Walk (2).png",
    "res/unitfiles/Ace/Walk (3).png",
    "res/unitfiles/Ace/Walk (4).png",
    "res/unitfiles/Ace/Walk (5).png",
    "res/unitfiles/Ace/Walk (6).png",
    "res/unitfiles/Ace/Walk (7).png",
    "res/unitfiles/Ace/Walk (8).png",
]
